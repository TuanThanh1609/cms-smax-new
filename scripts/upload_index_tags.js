...
const tagsFile = fs.readFileSync(__dirname + '/index_new_tags.json', 'utf8');
...
console.log('\n======================================================');
console.log(`⚡ ĐỒNG BỘ ${tags.length} NỘI DUNG MỚI LÊN SUPABASE (TRANG CHỦ - INDEX)`);
console.log('======================================================');
...
function syncToSupabase(supabaseUrl, supabaseKey) {
  console.log(`\n🚀 Đang gửi ${tags.length} thuộc tính nội dung của trang chủ lên Supabase...`);
  ...
  const req = https.request(reqOptions, (res) => {
    ...
    res.on('end', () => {
      ...
      if (res.statusCode >= 200 && res.statusCode < 300) {
        ...
        console.log('👉 Vui lòng chạy lệnh: vercel --prod dể cập nhật mã HTML mới lên máy chủ Vercel nếu chưa chạy.');
      } else {
